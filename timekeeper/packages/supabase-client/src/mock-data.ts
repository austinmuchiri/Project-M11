...
export const MOCK_ROUTINES: Routine[] = [
  {
    ...
    active: true,
    tasks: [
      { id: 't1', label: 'Wake Up',     icon: 'sun',    expectedMinutes: 2,  rewardStars: 1, scheduledTime: '07:00' },
      { id: 't2', label: 'Brush Teeth', icon: 'brush',  expectedMinutes: 3,  rewardStars: 1, scheduledTime: '07:10' },
      { id: 't3', label: 'Get Dressed', icon: 'shirt',  expectedMinutes: 5,  rewardStars: 1, scheduledTime: '07:20' },
      { id: 't4', label: 'Breakfast',   icon: 'plate',  expectedMinutes: 10, rewardStars: 1, scheduledTime: '07:30' },
      { id: 't5', label: 'Pack Bag',    icon: 'bag',    expectedMinutes: 5,  rewardStars: 1, scheduledTime: '07:40' },
    ],
  },
  {
    id: 'school',
    ...
    active: true,
    tasks: [
      { id: 's1', label: 'Math',    icon: 'pencil', expectedMinutes: 45, rewardStars: 2, scheduledTime: '09:00' },
      { id: 's2', label: 'Reading', icon: 'book',   expectedMinutes: 30, rewardStars: 2, scheduledTime: '10:30' },
      { id: 's3', label: 'Lunch',   icon: 'plate',  expectedMinutes: 30, rewardStars: 1, scheduledTime: '12:00' },
      { id: 's4', label: 'Science', icon: 'book',   expectedMinutes: 45, rewardStars: 2, scheduledTime: '13:30' },
    ],
  },
  {
    id: 'evening',
    ...
    active: true,
    tasks: [
      { id: 'e1', label: 'Dinner',   icon: 'plate',  expectedMinutes: 30, rewardStars: 1, scheduledTime: '18:30' },
      { id: 'e2', label: 'Homework', icon: 'pencil', expectedMinutes: 30, rewardStars: 2, scheduledTime: '19:00' },
      { id: 'e3', label: 'Shower',   icon: 'shower', expectedMinutes: 15, rewardStars: 1, scheduledTime: '19:45' },
      { id: 'e4', label: 'Read',     icon: 'book',   expectedMinutes: 20, rewardStars: 1, scheduledTime: '20:00' },
      { id: 'e5', label: 'Sleep',    icon: 'moon',   expectedMinutes: 1,  rewardStars: 1, scheduledTime: '20:30' },
    ],
  },
];
