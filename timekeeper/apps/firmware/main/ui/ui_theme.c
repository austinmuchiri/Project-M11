...
// External screen builders — defined in ui_<name>.c.
...
// ─────────────────────────────────────────────────────────
// Status bar — used at the top of every screen
// ─────────────────────────────────────────────────────────
...
lv_obj_t *ui_statusbar_create(lv_obj_t *parent)
{
    ...
    statusbar_t *s = lv_malloc(sizeof(statusbar_t));
...
{
    statusbar_t *s = lv_obj_get_user_data(bar);
