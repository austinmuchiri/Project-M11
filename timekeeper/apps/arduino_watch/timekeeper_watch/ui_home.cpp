// 01 · Home / clock face
// Layout: status bar (44) · time label (96px) · progress arc (210) · next-task card
...
lv_obj_t *ui_home_create(void)
{
    ...
    lv_label_set_text(date_lbl, "SUN \xc2\xb7 APR 25");
    ...
    lv_label_set_text(next_meta, "NEXT \xc2\xb7 7:30\nGet Dressed");
